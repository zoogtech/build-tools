/**************************************************************
    ...
    M610347.h - SFR define Header file for CCU8
...
#define MOACON (*(volatile unsigned char __near *)0xF3C0)
#define _B_MOACON (*(volatile _BYTE_FIELD __near *)0xF3C0)
...
#define MOA0EN		(_B_MOACON.b0)
#define MOA1EN		(_B_MOACON.b1)
#define MOA2EN		(_B_MOACON.b2)
/*---------------------------------------------------
