/**************************************************************
    ...
    M610xxx.h - Generic SFR define Header file for CCU8
...
#define RTCINT	0x007A
#define AL0INT	0x007C
#define AL1INT	0x007E
/*---------------------------------------------------
...
#define RTCSEC (*(volatile unsigned char __near *)0xF0C0)
#define _B_RTCSEC (*(volatile _BYTE_FIELD __near *)0xF0C0)

#define RTCMIN (*(volatile unsigned char __near *)0xF0C1)
#define _B_RTCMIN (*(volatile _BYTE_FIELD __near *)0xF0C1)

#define RTCHOUR (*(volatile unsigned char __near *)0xF0C2)
#define _B_RTCHOUR (*(volatile _BYTE_FIELD __near *)0xF0C2)

#define RTCWEEK (*(volatile unsigned char __near *)0xF0C3)
#define _B_RTCWEEK (*(volatile _BYTE_FIELD __near *)0xF0C3)

#define RTCDAY (*(volatile unsigned char __near *)0xF0C4)
#define _B_RTCDAY (*(volatile _BYTE_FIELD __near *)0xF0C4)

#define RTCMON (*(volatile unsigned char __near *)0xF0C5)
#define _B_RTCMON (*(volatile _BYTE_FIELD __near *)0xF0C5)

#define RTCYEAR (*(volatile unsigned char __near *)0xF0C6)
#define _B_RTCYEAR (*(volatile _BYTE_FIELD __near *)0xF0C6)

#define RTCCON (*(volatile unsigned char __near *)0xF0C7)
#define _B_RTCCON (*(volatile _BYTE_FIELD __near *)0xF0C7)

#define AL0MIN (*(volatile unsigned char __near *)0xF0C8)
#define _B_AL0MIN (*(volatile _BYTE_FIELD __near *)0xF0C8)

#define AL0HOUR (*(volatile unsigned char __near *)0xF0C9)
#define _B_AL0HOUR (*(volatile _BYTE_FIELD __near *)0xF0C9)

#define AL0WEEK (*(volatile unsigned char __near *)0xF0CA)
#define _B_AL0WEEK (*(volatile _BYTE_FIELD __near *)0xF0CA)

#define AL1MIN (*(volatile unsigned char __near *)0xF0CB)
#define _B_AL1MIN (*(volatile _BYTE_FIELD __near *)0xF0CB)

#define AL1HOUR (*(volatile unsigned char __near *)0xF0CC)
#define _B_AL1HOUR (*(volatile _BYTE_FIELD __near *)0xF0CC)

#define AL1DAY (*(volatile unsigned char __near *)0xF0CD)
#define _B_AL1DAY (*(volatile _BYTE_FIELD __near *)0xF0CD)

#define AL1MON (*(volatile unsigned char __near *)0xF0CE)
#define _B_AL1MON (*(volatile _BYTE_FIELD __near *)0xF0CE)
...
#define ERTC		(_B_IE7.b5)
#define EAL0		(_B_IE7.b6)
#define EAL1		(_B_IE7.b7)
...
#define QRTC		(_B_IRQ7.b5)
#define QAL0		(_B_IRQ7.b6)
#define QAL1		(_B_IRQ7.b7)
...
#define RS0		(_B_RTCSEC.b0)
#define RS1		(_B_RTCSEC.b1)
#define RS2		(_B_RTCSEC.b2)
#define RS3		(_B_RTCSEC.b3)
#define RS4		(_B_RTCSEC.b4)
#define RS5		(_B_RTCSEC.b5)
#define RS6		(_B_RTCSEC.b6)

#define RM0		(_B_RTCMIN.b0)
#define RM1		(_B_RTCMIN.b1)
#define RM2		(_B_RTCMIN.b2)
#define RM3		(_B_RTCMIN.b3)
#define RM4		(_B_RTCMIN.b4)
#define RM5		(_B_RTCMIN.b5)
#define RM6		(_B_RTCMIN.b6)

#define RH0		(_B_RTCHOUR.b0)
#define RH1		(_B_RTCHOUR.b1)
#define RH2		(_B_RTCHOUR.b2)
#define RH3		(_B_RTCHOUR.b3)
#define RH4		(_B_RTCHOUR.b4)
#define RH5		(_B_RTCHOUR.b5)

#define RW0		(_B_RTCWEEK.b0)
#define RW1		(_B_RTCWEEK.b1)
#define RW2		(_B_RTCWEEK.b2)

#define RD0		(_B_RTCDAY.b0)
#define RD1		(_B_RTCDAY.b1)
#define RD2		(_B_RTCDAY.b2)
#define RD3		(_B_RTCDAY.b3)
#define RD4		(_B_RTCDAY.b4)
#define RD5		(_B_RTCDAY.b5)

#define RMO0		(_B_RTCMON.b0)
#define RMO1		(_B_RTCMON.b1)
#define RMO2		(_B_RTCMON.b2)
#define RMO3		(_B_RTCMON.b3)
#define RMO4		(_B_RTCMON.b4)

#define RY0		(_B_RTCYEAR.b0)
#define RY1		(_B_RTCYEAR.b1)
#define RY2		(_B_RTCYEAR.b2)
#define RY3		(_B_RTCYEAR.b3)
#define RY4		(_B_RTCYEAR.b4)
#define RY5		(_B_RTCYEAR.b5)
#define RY6		(_B_RTCYEAR.b6)
#define RY7		(_B_RTCYEAR.b7)

#define RTCEN		(_B_RTCCON.b0)
#define RIN0		(_B_RTCCON.b1)
#define RIN1		(_B_RTCCON.b2)

#define AL0M0		(_B_AL0MIN.b0)
#define AL0M1		(_B_AL0MIN.b1)
#define AL0M2		(_B_AL0MIN.b2)
#define AL0M3		(_B_AL0MIN.b3)
#define AL0M4		(_B_AL0MIN.b4)
#define AL0M5		(_B_AL0MIN.b5)
#define AL0M6		(_B_AL0MIN.b6)

#define AL0H0		(_B_AL0HOUR.b0)
#define AL0H1		(_B_AL0HOUR.b1)
#define AL0H2		(_B_AL0HOUR.b2)
#define AL0H3		(_B_AL0HOUR.b3)
#define AL0H4		(_B_AL0HOUR.b4)
#define AL0H5		(_B_AL0HOUR.b5)

#define AL0W0		(_B_AL0WEEK.b0)
#define AL0W1		(_B_AL0WEEK.b1)
#define AL0W2		(_B_AL0WEEK.b2)

#define AL1M0		(_B_AL1MIN.b0)
#define AL1M1		(_B_AL1MIN.b1)
#define AL1M2		(_B_AL1MIN.b2)
#define AL1M3		(_B_AL1MIN.b3)
#define AL1M4		(_B_AL1MIN.b4)
#define AL1M5		(_B_AL1MIN.b5)
#define AL1M6		(_B_AL1MIN.b6)

#define AL1H0		(_B_AL1HOUR.b0)
#define AL1H1		(_B_AL1HOUR.b1)
#define AL1H2		(_B_AL1HOUR.b2)
#define AL1H3		(_B_AL1HOUR.b3)
#define AL1H4		(_B_AL1HOUR.b4)
#define AL1H5		(_B_AL1HOUR.b5)

#define AL1D0		(_B_AL1DAY.b0)
#define AL1D1		(_B_AL1DAY.b1)
#define AL1D2		(_B_AL1DAY.b2)
#define AL1D3		(_B_AL1DAY.b3)
#define AL1D4		(_B_AL1DAY.b4)
#define AL1D5		(_B_AL1DAY.b5)

#define AL1MO0		(_B_AL1MON.b0)
#define AL1MO1		(_B_AL1MON.b1)
#define AL1MO2		(_B_AL1MON.b2)
#define AL1MO3		(_B_AL1MON.b3)
#define AL1MO4		(_B_AL1MON.b4)
