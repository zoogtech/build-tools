/**************************************************************
    ...
    M610439.H - SFR define Header file for CCU8

    #CORE           "nX-U8/100"
    #TARGET         "ML610439"
    #VERSION        "1.00"
    Last Edition  Apr 19, 2010
...
#define PW1INT	0x0062
#define PW2INT	0x0064
#define T1KINT	0x0068
#define T128HINT	0x006A
#define T64HINT	0x006C
#define T32HINT	0x006E
#define T16HINT	0x0070
#define T8HINT	0x0072
#define T4HINT	0x0074
#define T2HINT	0x0076
#define T1HINT	0x0078
/*---------------------------------------------------
...
#define PW1P (*(volatile unsigned int __near *)0xF0A8)

#define PW1PL (*(volatile unsigned char __near *)0xF0A8)
#define _B_PW1PL (*(volatile _BYTE_FIELD __near *)0xF0A8)

#define PW1PH (*(volatile unsigned char __near *)0xF0A9)
#define _B_PW1PH (*(volatile _BYTE_FIELD __near *)0xF0A9)

#define PW1D (*(volatile unsigned int __near *)0xF0AA)

#define PW1DL (*(volatile unsigned char __near *)0xF0AA)
#define _B_PW1DL (*(volatile _BYTE_FIELD __near *)0xF0AA)

#define PW1DH (*(volatile unsigned char __near *)0xF0AB)
#define _B_PW1DH (*(volatile _BYTE_FIELD __near *)0xF0AB)

#define PW1C (*(volatile unsigned int __near *)0xF0AC)

#define PW1CL (*(volatile unsigned char __near *)0xF0AC)
#define _B_PW1CL (*(volatile _BYTE_FIELD __near *)0xF0AC)

#define PW1CH (*(volatile unsigned char __near *)0xF0AD)
#define _B_PW1CH (*(volatile _BYTE_FIELD __near *)0xF0AD)

#define PW1CON (*(volatile unsigned int __near *)0xF0AE)

#define PW1CON0 (*(volatile unsigned char __near *)0xF0AE)
#define _B_PW1CON0 (*(volatile _BYTE_FIELD __near *)0xF0AE)

#define PW1CON1 (*(volatile unsigned char __near *)0xF0AF)
#define _B_PW1CON1 (*(volatile _BYTE_FIELD __near *)0xF0AF)

#define PW2P (*(volatile unsigned int __near *)0xF0B0)

#define PW2PL (*(volatile unsigned char __near *)0xF0B0)
#define _B_PW2PL (*(volatile _BYTE_FIELD __near *)0xF0B0)

#define PW2PH (*(volatile unsigned char __near *)0xF0B1)
#define _B_PW2PH (*(volatile _BYTE_FIELD __near *)0xF0B1)

#define PW2D (*(volatile unsigned int __near *)0xF0B2)

#define PW2DL (*(volatile unsigned char __near *)0xF0B2)
#define _B_PW2DL (*(volatile _BYTE_FIELD __near *)0xF0B2)

#define PW2DH (*(volatile unsigned char __near *)0xF0B3)
#define _B_PW2DH (*(volatile _BYTE_FIELD __near *)0xF0B3)

#define PW2C (*(volatile unsigned int __near *)0xF0B4)

#define PW2CL (*(volatile unsigned char __near *)0xF0B4)
#define _B_PW2CL (*(volatile _BYTE_FIELD __near *)0xF0B4)

#define PW2CH (*(volatile unsigned char __near *)0xF0B5)
#define _B_PW2CH (*(volatile _BYTE_FIELD __near *)0xF0B5)

#define PW2CON (*(volatile unsigned int __near *)0xF0B6)

#define PW2CON0 (*(volatile unsigned char __near *)0xF0B6)
#define _B_PW2CON0 (*(volatile _BYTE_FIELD __near *)0xF0B6)

#define PW2CON1 (*(volatile unsigned char __near *)0xF0B7)
#define _B_PW2CON1 (*(volatile _BYTE_FIELD __near *)0xF0B7)
...
#define SEGOUT0 (*(volatile unsigned char __near *)0xF0F6)
#define _B_SEGOUT0 (*(volatile _BYTE_FIELD __near *)0xF0F6)

#define SEGOUT1 (*(volatile unsigned char __near *)0xF0F7)
#define _B_SEGOUT1 (*(volatile _BYTE_FIELD __near *)0xF0F7)

#define SEGOUT2 (*(volatile unsigned char __near *)0xF0F8)
#define _B_SEGOUT2 (*(volatile _BYTE_FIELD __near *)0xF0F8)

#define SEGOUT3 (*(volatile unsigned char __near *)0xF0F9)
#define _B_SEGOUT3 (*(volatile _BYTE_FIELD __near *)0xF0F9)
...
#define DSPR72 (*(volatile unsigned char __near *)0xF172)

#define DSPR73 (*(volatile unsigned char __near *)0xF173)

#define DSPR74 (*(volatile unsigned char __near *)0xF174)

#define DSPR75 (*(volatile unsigned char __near *)0xF175)

#define DSPR76 (*(volatile unsigned char __near *)0xF176)

#define DSPR77 (*(volatile unsigned char __near *)0xF177)

#define DSPR78 (*(volatile unsigned char __near *)0xF178)

#define DSPR79 (*(volatile unsigned char __near *)0xF179)

#define DSPR7A (*(volatile unsigned char __near *)0xF17A)

#define DSPR7B (*(volatile unsigned char __near *)0xF17B)

#define DSPR7C (*(volatile unsigned char __near *)0xF17C)

#define DSPR7D (*(volatile unsigned char __near *)0xF17D)

#define DSPR7E (*(volatile unsigned char __near *)0xF17E)

#define DSPR7F (*(volatile unsigned char __near *)0xF17F)

#define DSPR80 (*(volatile unsigned char __near *)0xF180)

#define DSPR81 (*(volatile unsigned char __near *)0xF181)

#define DSPR82 (*(volatile unsigned char __near *)0xF182)

#define DSPR83 (*(volatile unsigned char __near *)0xF183)

#define DSPR84 (*(volatile unsigned char __near *)0xF184)

#define DSPR85 (*(volatile unsigned char __near *)0xF185)

#define DSPR86 (*(volatile unsigned char __near *)0xF186)

#define DSPR87 (*(volatile unsigned char __near *)0xF187)

#define DSPR88 (*(volatile unsigned char __near *)0xF188)

#define DSPR89 (*(volatile unsigned char __near *)0xF189)

#define DSPR8A (*(volatile unsigned char __near *)0xF18A)

#define DSPR8B (*(volatile unsigned char __near *)0xF18B)

#define DSPR8C (*(volatile unsigned char __near *)0xF18C)

#define DSPR8D (*(volatile unsigned char __near *)0xF18D)

#define DSPR8E (*(volatile unsigned char __near *)0xF18E)

#define DSPR8F (*(volatile unsigned char __near *)0xF18F)

#define DSPR90 (*(volatile unsigned char __near *)0xF190)

#define DSPR91 (*(volatile unsigned char __near *)0xF191)

#define DSPR92 (*(volatile unsigned char __near *)0xF192)

#define DSPR93 (*(volatile unsigned char __near *)0xF193)

#define DSPR94 (*(volatile unsigned char __near *)0xF194)

#define DSPR95 (*(volatile unsigned char __near *)0xF195)

#define DSPR96 (*(volatile unsigned char __near *)0xF196)

#define DSPR97 (*(volatile unsigned char __near *)0xF197)

#define DSPR98 (*(volatile unsigned char __near *)0xF198)

#define DSPR99 (*(volatile unsigned char __near *)0xF199)

#define DSPR9A (*(volatile unsigned char __near *)0xF19A)

#define DSPR9B (*(volatile unsigned char __near *)0xF19B)

#define DSPR9C (*(volatile unsigned char __near *)0xF19C)

#define DSPR9D (*(volatile unsigned char __near *)0xF19D)

#define DSPR9E (*(volatile unsigned char __near *)0xF19E)

#define DSPR9F (*(volatile unsigned char __near *)0xF19F)

#define DSPRA0 (*(volatile unsigned char __near *)0xF1A0)

#define DSPRA1 (*(volatile unsigned char __near *)0xF1A1)

#define DSPRA2 (*(volatile unsigned char __near *)0xF1A2)

#define DSPRA3 (*(volatile unsigned char __near *)0xF1A3)

#define DSPRA4 (*(volatile unsigned char __near *)0xF1A4)

#define DSPRA5 (*(volatile unsigned char __near *)0xF1A5)

#define DSPRA6 (*(volatile unsigned char __near *)0xF1A6)

#define DSPRA7 (*(volatile unsigned char __near *)0xF1A7)

#define DSPRA8 (*(volatile unsigned char __near *)0xF1A8)

#define DSPRA9 (*(volatile unsigned char __near *)0xF1A9)

#define DSPRAA (*(volatile unsigned char __near *)0xF1AA)

#define DSPRAB (*(volatile unsigned char __near *)0xF1AB)

#define DSPRAC (*(volatile unsigned char __near *)0xF1AC)

#define DSPRAD (*(volatile unsigned char __near *)0xF1AD)

#define DSPRAE (*(volatile unsigned char __near *)0xF1AE)

#define DSPRAF (*(volatile unsigned char __near *)0xF1AF)

#define DSPRB0 (*(volatile unsigned char __near *)0xF1B0)

#define DSPRB1 (*(volatile unsigned char __near *)0xF1B1)

#define DSPRB2 (*(volatile unsigned char __near *)0xF1B2)

#define DSPRB3 (*(volatile unsigned char __near *)0xF1B3)

#define DSPRB4 (*(volatile unsigned char __near *)0xF1B4)

#define DSPRB5 (*(volatile unsigned char __near *)0xF1B5)

#define DSPRB6 (*(volatile unsigned char __near *)0xF1B6)

#define DSPRB7 (*(volatile unsigned char __near *)0xF1B7)

#define DSPRB8 (*(volatile unsigned char __near *)0xF1B8)

#define DSPRB9 (*(volatile unsigned char __near *)0xF1B9)

#define DSPRBA (*(volatile unsigned char __near *)0xF1BA)

#define DSPRBB (*(volatile unsigned char __near *)0xF1BB)

#define DSPRBC (*(volatile unsigned char __near *)0xF1BC)

#define DSPRBD (*(volatile unsigned char __near *)0xF1BD)

#define DSPRBE (*(volatile unsigned char __near *)0xF1BE)

#define DSPRBF (*(volatile unsigned char __near *)0xF1BF)

#define DSPRC0 (*(volatile unsigned char __near *)0xF1C0)

#define DSPRC1 (*(volatile unsigned char __near *)0xF1C1)

#define DSPRC2 (*(volatile unsigned char __near *)0xF1C2)

#define DSPRC3 (*(volatile unsigned char __near *)0xF1C3)

#define DSPRC4 (*(volatile unsigned char __near *)0xF1C4)

#define DSPRC5 (*(volatile unsigned char __near *)0xF1C5)

#define DSPRC6 (*(volatile unsigned char __near *)0xF1C6)

#define DSPRC7 (*(volatile unsigned char __near *)0xF1C7)

#define DSPRC8 (*(volatile unsigned char __near *)0xF1C8)

#define DSPRC9 (*(volatile unsigned char __near *)0xF1C9)

#define DSPRCA (*(volatile unsigned char __near *)0xF1CA)

#define DSPRCB (*(volatile unsigned char __near *)0xF1CB)

#define DSPRCC (*(volatile unsigned char __near *)0xF1CC)

#define DSPRCD (*(volatile unsigned char __near *)0xF1CD)

#define DSPRCE (*(volatile unsigned char __near *)0xF1CE)

#define DSPRCF (*(volatile unsigned char __near *)0xF1CF)

#define DSPRD0 (*(volatile unsigned char __near *)0xF1D0)

#define DSPRD1 (*(volatile unsigned char __near *)0xF1D1)

#define DSPRD2 (*(volatile unsigned char __near *)0xF1D2)

#define DSPRD3 (*(volatile unsigned char __near *)0xF1D3)

#define DSPRD4 (*(volatile unsigned char __near *)0xF1D4)

#define DSPRD5 (*(volatile unsigned char __near *)0xF1D5)

#define DSPRD6 (*(volatile unsigned char __near *)0xF1D6)

#define DSPRD7 (*(volatile unsigned char __near *)0xF1D7)

#define DSPRD8 (*(volatile unsigned char __near *)0xF1D8)

#define DSPRD9 (*(volatile unsigned char __near *)0xF1D9)

#define DSPRDA (*(volatile unsigned char __near *)0xF1DA)

#define DSPRDB (*(volatile unsigned char __near *)0xF1DB)

#define DSPRDC (*(volatile unsigned char __near *)0xF1DC)

#define DSPRDD (*(volatile unsigned char __near *)0xF1DD)

#define DSPRDE (*(volatile unsigned char __near *)0xF1DE)

#define DSPRDF (*(volatile unsigned char __near *)0xF1DF)

#define DSPRE0 (*(volatile unsigned char __near *)0xF1E0)

#define DSPRE1 (*(volatile unsigned char __near *)0xF1E1)

#define DSPRE2 (*(volatile unsigned char __near *)0xF1E2)

#define DSPRE3 (*(volatile unsigned char __near *)0xF1E3)

#define DSPRE4 (*(volatile unsigned char __near *)0xF1E4)

#define DSPRE5 (*(volatile unsigned char __near *)0xF1E5)

#define DSPRE6 (*(volatile unsigned char __near *)0xF1E6)

#define DSPRE7 (*(volatile unsigned char __near *)0xF1E7)

#define DSPRE8 (*(volatile unsigned char __near *)0xF1E8)

#define DSPRE9 (*(volatile unsigned char __near *)0xF1E9)

#define DSPREA (*(volatile unsigned char __near *)0xF1EA)

#define DSPREB (*(volatile unsigned char __near *)0xF1EB)

#define DSPREC (*(volatile unsigned char __near *)0xF1EC)

#define DSPRED (*(volatile unsigned char __near *)0xF1ED)

#define DSPREE (*(volatile unsigned char __near *)0xF1EE)

#define DSPREF (*(volatile unsigned char __near *)0xF1EF)

#define DSPRF0 (*(volatile unsigned char __near *)0xF1F0)

#define DSPRF1 (*(volatile unsigned char __near *)0xF1F1)

#define DSPRF2 (*(volatile unsigned char __near *)0xF1F2)

#define DSPRF3 (*(volatile unsigned char __near *)0xF1F3)

#define DSPRF4 (*(volatile unsigned char __near *)0xF1F4)

#define DSPRF5 (*(volatile unsigned char __near *)0xF1F5)

#define DSPRF6 (*(volatile unsigned char __near *)0xF1F6)

#define DSPRF7 (*(volatile unsigned char __near *)0xF1F7)

#define DSPRF8 (*(volatile unsigned char __near *)0xF1F8)

#define DSPRF9 (*(volatile unsigned char __near *)0xF1F9)

#define DSPRFA (*(volatile unsigned char __near *)0xF1FA)

#define DSPRFB (*(volatile unsigned char __near *)0xF1FB)

#define DSPRFC (*(volatile unsigned char __near *)0xF1FC)

#define DSPRFD (*(volatile unsigned char __near *)0xF1FD)

#define DSPRFE (*(volatile unsigned char __near *)0xF1FE)
...
#define P2MOD (*(volatile unsigned int __near *)0xF214)

#define P2MOD0 (*(volatile unsigned char __near *)0xF214)
#define _B_P2MOD0 (*(volatile _BYTE_FIELD __near *)0xF214)

#define P2MOD1 (*(volatile unsigned char __near *)0xF215)
#define _B_P2MOD1 (*(volatile _BYTE_FIELD __near *)0xF215)

#define P2MOD2 (*(volatile unsigned char __near *)0xF216)
#define _B_P2MOD2 (*(volatile _BYTE_FIELD __near *)0xF216)
...
#define AMPOFFS (*(volatile unsigned char __near *)0xF2F4)
#define _B_AMPOFFS (*(volatile _BYTE_FIELD __near *)0xF2F4)

#define AMPGAIN (*(volatile unsigned char __near *)0xF2F5)
#define _B_AMPGAIN (*(volatile _BYTE_FIELD __near *)0xF2F5)

#define AMPCON0 (*(volatile unsigned char __near *)0xF2F6)
#define _B_AMPCON0 (*(volatile _BYTE_FIELD __near *)0xF2F6)
...
#define EPW1		(_B_IE6.b1)
#define EPW2		(_B_IE6.b2)
#define ET1K		(_B_IE6.b4)
#define E128H		(_B_IE6.b5)
#define E64H		(_B_IE6.b6)
#define E32H		(_B_IE6.b7)

#define E16H		(_B_IE7.b0)
#define E8H		(_B_IE7.b1)
#define E4H		(_B_IE7.b2)
#define E2H		(_B_IE7.b3)
#define E1H		(_B_IE7.b4)
...
#define QPW1		(_B_IRQ6.b1)
#define QPW2		(_B_IRQ6.b2)
#define QT1K		(_B_IRQ6.b4)
#define Q128H		(_B_IRQ6.b5)
#define Q64H		(_B_IRQ6.b6)
#define Q32H		(_B_IRQ6.b7)

#define Q16H		(_B_IRQ7.b0)
#define Q8H		(_B_IRQ7.b1)
#define Q4H		(_B_IRQ7.b2)
#define Q2H		(_B_IRQ7.b3)
#define Q1H		(_B_IRQ7.b4)
...
#define DPW1		(_B_BLKCON1.b1)
#define DPW2		(_B_BLKCON1.b2)
...
#define T0CS2		(_B_TM0CON0.b2)
#define T0CS3		(_B_TM0CON0.b3)
#define T0OST		(_B_TM0CON0.b4)
#define T01M16		(_B_TM0CON0.b5)
...
#define T1CS2		(_B_TM1CON0.b2)
#define T1CS3		(_B_TM1CON0.b3)
#define T1OST		(_B_TM1CON0.b4)
...
#define T2CS2		(_B_TM2CON0.b2)
#define T2CS3		(_B_TM2CON0.b3)
#define T2OST		(_B_TM2CON0.b4)
#define T21M16		(_B_TM2CON0.b5)
...
#define T3CS2		(_B_TM3CON0.b2)
#define T3CS3		(_B_TM3CON0.b3)
#define T3OST		(_B_TM3CON0.b4)
...
#define P1P0		(_B_PW1PL.b0)
#define P1P1		(_B_PW1PL.b1)
#define P1P2		(_B_PW1PL.b2)
#define P1P3		(_B_PW1PL.b3)
#define P1P4		(_B_PW1PL.b4)
#define P1P5		(_B_PW1PL.b5)
#define P1P6		(_B_PW1PL.b6)
#define P1P7		(_B_PW1PL.b7)

#define P1P8		(_B_PW1PH.b0)
#define P1P9		(_B_PW1PH.b1)
#define P1P10		(_B_PW1PH.b2)
#define P1P11		(_B_PW1PH.b3)
#define P1P12		(_B_PW1PH.b4)
#define P1P13		(_B_PW1PH.b5)
#define P1P14		(_B_PW1PH.b6)
#define P1P15		(_B_PW1PH.b7)

#define P1D0		(_B_PW1DL.b0)
#define P1D1		(_B_PW1DL.b1)
#define P1D2		(_B_PW1DL.b2)
#define P1D3		(_B_PW1DL.b3)
#define P1D4		(_B_PW1DL.b4)
#define P1D5		(_B_PW1DL.b5)
#define P1D6		(_B_PW1DL.b6)
#define P1D7		(_B_PW1DL.b7)

#define P1D8		(_B_PW1DH.b0)
#define P1D9		(_B_PW1DH.b1)
#define P1D10		(_B_PW1DH.b2)
#define P1D11		(_B_PW1DH.b3)
#define P10D12		(_B_PW1DH.b4)
#define P1D13		(_B_PW1DH.b5)
#define P1D14		(_B_PW1DH.b6)
#define P1D15		(_B_PW1DH.b7)

#define P1C0		(_B_PW1CL.b0)
#define P1C1		(_B_PW1CL.b1)
#define P1C2		(_B_PW1CL.b2)
#define P1C3		(_B_PW1CL.b3)
#define P1C4		(_B_PW1CL.b4)
#define P1C5		(_B_PW1CL.b5)
#define P1C6		(_B_PW1CL.b6)
#define P1C7		(_B_PW1CL.b7)

#define P1C8		(_B_PW1CH.b0)
#define P1C9		(_B_PW1CH.b1)
#define P1C10		(_B_PW1CH.b2)
#define P1C11		(_B_PW1CH.b3)
#define P1C12		(_B_PW1CH.b4)
#define P1C13		(_B_PW1CH.b5)
#define P1C14		(_B_PW1CH.b6)
#define P1C15		(_B_PW1CH.b7)

#define P1CS0		(_B_PW1CON0.b0)
#define P1CS1		(_B_PW1CON0.b1)
#define P1IS0		(_B_PW1CON0.b2)
#define P1IS1		(_B_PW1CON0.b3)
#define P1NEG		(_B_PW1CON0.b4)

#define P1RUN		(_B_PW1CON1.b0)
#define P1FLG		(_B_PW1CON1.b6)
#define P1STAT		(_B_PW1CON1.b7)

#define P2P0		(_B_PW2PL.b0)
#define P2P1		(_B_PW2PL.b1)
#define P2P2		(_B_PW2PL.b2)
#define P2P3		(_B_PW2PL.b3)
#define P2P4		(_B_PW2PL.b4)
#define P2P5		(_B_PW2PL.b5)
#define P2P6		(_B_PW2PL.b6)
#define P2P7		(_B_PW2PL.b7)

#define P2P8		(_B_PW2PH.b0)
#define P2P9		(_B_PW2PH.b1)
#define P2P10		(_B_PW2PH.b2)
#define P2P11		(_B_PW2PH.b3)
#define P2P12		(_B_PW2PH.b4)
#define P2P13		(_B_PW2PH.b5)
#define P2P14		(_B_PW2PH.b6)
#define P2P15		(_B_PW2PH.b7)

#define P2D0		(_B_PW2DL.b0)
#define P2D1		(_B_PW2DL.b1)
#define P2D2		(_B_PW2DL.b2)
#define P2D3		(_B_PW2DL.b3)
#define P2D4		(_B_PW2DL.b4)
#define P2D5		(_B_PW2DL.b5)
#define P2D6		(_B_PW2DL.b6)
#define P2D7		(_B_PW2DL.b7)

#define P2D8		(_B_PW2DH.b0)
#define P2D9		(_B_PW2DH.b1)
#define P2D10		(_B_PW2DH.b2)
#define P2D11		(_B_PW2DH.b3)
#define P2D12		(_B_PW2DH.b4)
#define P2D13		(_B_PW2DH.b5)
#define P2D14		(_B_PW2DH.b6)
#define P2D15		(_B_PW2DH.b7)

#define P2C0		(_B_PW2CL.b0)
#define P2C1		(_B_PW2CL.b1)
#define P2C2		(_B_PW2CL.b2)
#define P2C3		(_B_PW2CL.b3)
#define P2C4		(_B_PW2CL.b4)
#define P2C5		(_B_PW2CL.b5)
#define P2C6		(_B_PW2CL.b6)
#define P2C7		(_B_PW2CL.b7)

#define P2C8		(_B_PW2CH.b0)
#define P2C9		(_B_PW2CH.b1)
#define P2C10		(_B_PW2CH.b2)
#define P2C11		(_B_PW2CH.b3)
#define P2C12		(_B_PW2CH.b4)
#define P2C13		(_B_PW2CH.b5)
#define P2C14		(_B_PW2CH.b6)
#define P2C15		(_B_PW2CH.b7)

#define P2CS0		(_B_PW2CON0.b0)
#define P2CS1		(_B_PW2CON0.b1)
#define P2IS0		(_B_PW2CON0.b2)
#define P2IS1		(_B_PW2CON0.b3)
#define P2NEG		(_B_PW2CON0.b4)

#define P2RUN		(_B_PW2CON1.b0)
#define P2FLG		(_B_PW2CON1.b6)
#define P2STAT		(_B_PW2CON1.b7)
...
#define DUTY4		(_B_DSPMOD0.b4)
#define FRM0		(_B_DSPMOD0.b5)
#define FRM1		(_B_DSPMOD0.b6)
#define FRM2		(_B_DSPMOD0.b7)
...
#define SEGO56		(_B_SEGOUT0.b0)
#define SEGO57		(_B_SEGOUT0.b1)
#define SEGO58		(_B_SEGOUT0.b2)
#define SEGO59		(_B_SEGOUT0.b3)
#define SEGO60		(_B_SEGOUT0.b4)
#define SEGO61		(_B_SEGOUT0.b5)
#define SEGO62		(_B_SEGOUT0.b6)
#define SEGO63		(_B_SEGOUT0.b7)

#define SEGO48		(_B_SEGOUT1.b0)
#define SEGO49		(_B_SEGOUT1.b1)
#define SEGO50		(_B_SEGOUT1.b2)
#define SEGO51		(_B_SEGOUT1.b3)
#define SEGO52		(_B_SEGOUT1.b4)
#define SEGO53		(_B_SEGOUT1.b5)
#define SEGO54		(_B_SEGOUT1.b6)
#define SEGO55		(_B_SEGOUT1.b7)

#define SEGO40		(_B_SEGOUT2.b0)
#define SEGO41		(_B_SEGOUT2.b1)
#define SEGO42		(_B_SEGOUT2.b2)
#define SEGO43		(_B_SEGOUT2.b3)
#define SEGO44		(_B_SEGOUT2.b4)
#define SEGO45		(_B_SEGOUT2.b5)
#define SEGO46		(_B_SEGOUT2.b6)
#define SEGO47		(_B_SEGOUT2.b7)

#define SEGO32		(_B_SEGOUT3.b0)
#define SEGO33		(_B_SEGOUT3.b1)
#define SEGO34		(_B_SEGOUT3.b2)
#define SEGO35		(_B_SEGOUT3.b3)
#define SEGO36		(_B_SEGOUT3.b4)
#define SEGO37		(_B_SEGOUT3.b5)
#define SEGO38		(_B_SEGOUT3.b6)
#define SEGO39		(_B_SEGOUT3.b7)
...
#define P20MD0		(_B_P2MOD0.b0)
#define P21MD0		(_B_P2MOD0.b1)
#define P22MD0		(_B_P2MOD0.b2)

#define P20MD1		(_B_P2MOD1.b0)
#define P21MD1		(_B_P2MOD1.b1)
#define P22MD1		(_B_P2MOD1.b2)

#define OCK0		(_B_P2MOD2.b0)
#define OCK1		(_B_P2MOD2.b1)
...
#define AMPO0		(_B_AMPOFFS.b0)
#define AMPO1		(_B_AMPOFFS.b1)
#define AMPO2		(_B_AMPOFFS.b2)
#define AMPO3		(_B_AMPOFFS.b3)
#define AMPO4		(_B_AMPOFFS.b4)

#define AMPG0		(_B_AMPGAIN.b0)
#define AMPG1		(_B_AMPGAIN.b1)
#define AMPG2		(_B_AMPGAIN.b2)
#define AMPG3		(_B_AMPGAIN.b3)

#define AMPEN0		(_B_AMPCON0.b0)
#define AMPEN1		(_B_AMPCON0.b1)
#define AMPADJ		(_B_AMPCON0.b2)
